        ...
        <div
            ...
            <div class="flex sm:flex-row flex-col gap-3 pb-4 border-b">
                <div class="mb-2 sm:w-1/3">
                    ...
                    <p class="text-gray-800 font-semibold">{{ $u->req_id }}</p>
                </div>
            ...
            <div class="flex sm:flex-row flex-col gap-3 pb-4 border-b">
                ...
                <div class="mb-2 sm:w-1/3">
                    ...
                    <p class="text-gray-800 font-semibold">{{ $u->nationality }}</p>
                </div>
            </div>
            <div class="mb-2 flex sm:flex-row flex-col gap-3">
                <div class="mb-2 sm:w-1/3">
                    ...
                    <p class="text-gray-800 font-semibold">{{ $u->phone }}</p>
                </div>
                <div class="mb-2 sm:w-2/3">
                    <label for="passport" class="text-sm font-medium text-gray-900 block mb-2 dark:text-gray-300">
                        Passport ID
                    </label>
                    <p class="text-gray-800 font-semibold">{{ $u->passport_id }}</p>
                </div>
            </div>
            <div class="mb-2">
                ...
                <p class="text-gray-800 font-semibold">{{ $u->address_indonesia }}</p>
            </div>
        </div>
    @endforeach
@endsection
