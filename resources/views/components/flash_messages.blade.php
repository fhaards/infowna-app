@if (Session::has('success'))
    <div id="alert-3" class="flex bg-green-100 rounded-lg p-4 mb-4 dark:bg-green-200" role="alert">
        <svg class="w-5 h-5 text-green-700 flex-shrink-0 dark:text-green-800" fill="currentColor" viewBox="0 0 20 20"
...
@if (Session::has('error'))
    <div id="alert-2" class="flex bg-red-100 rounded-lg p-4 mb-4 dark:bg-red-200" role="alert">
        <svg class="w-5 h-5 text-red-700 flex-shrink-0 dark:text-red-800" fill="currentColor" viewBox="0 0 20 20"
            xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd"
                d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z"
                clip-rule="evenodd"></path>
...
@if (Session::has('warning'))
    <div id="alert-4" class="flex bg-yellow-100 rounded-lg p-4 mb-4 dark:bg-yellow-200" role="alert">
        ...
        <button type="button"
            ...
            data-collapse-toggle="alert-4" aria-label="Close">
            <span class="sr-only">Close</span>
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd"
                    d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
...
@if (Session::has('info'))
    <div id="alert-1" class="flex bg-blue-100 rounded-lg p-4 mb-4 dark:bg-blue-200" role="alert">
        <svg class="w-5 h-5 text-blue-700 flex-shrink-0 dark:text-blue-800" fill="currentColor" viewBox="0 0 20 20"
            xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd"
                d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z"
                clip-rule="evenodd"></path>
